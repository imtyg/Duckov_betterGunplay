...
2. 修复半自动武器问题
修复了在奔跑状态下开火时，第一发子弹无法射击的 bug。

3. 优化打断逻辑
现在可以通过 开火（鼠标左键） 来打断正在进行的互动，无需再按那个诡异的x键。

4. 翻滚换弹衔接 （v1.1更新）
现在在换弹时翻滚，翻滚动作完成后会自动衔接之前的换弹动作并完成换弹，无需从头开始换弹。

5. 更智能的切枪 （v1.2更新）
- 翻滚时切换武器，会在翻滚结束后自动切换
- 按c收起武器空手时，开火会自动切换至上次使用的武器开火

6. 空仓自动换弹 （v1.2更新）
全自动武器会在空仓时自动换弹，即使不松开开火键也如此。

7. 翻滚打断场景互动 （v1.2更新）
使用翻滚会打断正在进行的场景互动，如挖掘，放置任务道具。
